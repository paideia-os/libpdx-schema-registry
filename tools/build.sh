...
#
# Mirrors the libpdx-audit / libpdx-semantic-pipe resolution scheme so a
# consumer that clones this repo next to a paideia-os checkout gets a
# working build without env-var plumbing.
